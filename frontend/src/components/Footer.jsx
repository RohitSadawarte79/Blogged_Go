...
const Footer = () => {
    return (
        <footer className="w-full max-sm:hidden bg-[#111111] text-[#a3a3a3] py-6 px-4 md:px-12 flex flex-col md:flex-row items-center justify-between text-xs sm:text-sm tracking-widest mt-auto z-10 relative">
